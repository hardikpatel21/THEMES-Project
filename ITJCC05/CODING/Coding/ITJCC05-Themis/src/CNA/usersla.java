...
/**
 * Servlet implementation class usersla
 */
public class usersla extends HttpServlet {
	    	       ...
	    	       if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
	    	        ...
	    	        //   System.out.println("file is nnnnnnnnnnn="+file+"xxxxxxxxxxxxxxx");
	    	         ...
	    	         //  FileOutputStream fileOut = new FileOutputStream("D:\\VIVEK\\ITJCC04\\ITJCC04\\PUBLIC CLOUD\\build\\web\\"+saveFile);
	    	           uploadedfile =context.getInitParameter("uploadedpath1");
	    	           ...
	    	           HttpSession hs=request.getSession();
	    				...
	    				String path1="D:/projectfinal/ITJCC05/CODING/Coding/ITJCC05-Themis/WebContent/USLA"+"/"+saveFile;
	    				int p=s[1].indexOf(".");
	    				...
	    				int j=st.executeUpdate("update receivesla set slauser='"+path1+"', DATE='"+date+"' where name='"+name+"' and sw='"+sw+"'");
	    				System.out.println("update receivesla set slauser='"+path1+"' and DATE='"+date+"' where name='"+name+"' and sw='"+sw+"'");
	    				}
	    				catch(Exception e)
	    				{
	    					e.printStackTrace();
	    				...
	    				response.sendRedirect("http://localhost:8084/ITJCC05/Bill2.jsp");
