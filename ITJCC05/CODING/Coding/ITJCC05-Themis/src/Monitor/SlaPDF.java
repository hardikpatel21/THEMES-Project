...
public class SlaPDF
{
	public  void sla(List sla_list)throws Exception
    {
  	...
  	String id= (String) sla_list.get(8);
  	String date=(String)sla_list.get(9);
  	String path=sla_list.get(10).toString();
...
//		image3. scaleAbsolute(24,25);
			...
			System.out.println("Your Account id for this software is "+id);
