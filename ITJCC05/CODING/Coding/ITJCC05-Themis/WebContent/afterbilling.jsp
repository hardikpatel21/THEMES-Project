...
<div class="main">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li ><a href="SLA.jsp">SLA </a></li>
           <li class="active" ><a href="afterbilling.jsp">Bill </a></li>
  ...
  <tr>
    ...
    <th width="45" scope="col"><font color="#990066">CNA SLA copy </font></th>
    <th width="48" scope="col"><font color="#990066">USER SLA copy</font></th>
    <th width="48" scope="col"><font color="#990066">BILL DATE</font></th>
...
<tr>
	...
	<td>
	<a href="BILL/<%=us+"-"+so+" bill.pdf" %>">bill</a>
	</td>
