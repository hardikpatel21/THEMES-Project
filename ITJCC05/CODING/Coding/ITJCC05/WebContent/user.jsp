    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="user.jsp"><span>USER DETAILS</span></a></li>
  ...
  <div class="content">
    ...
    <div class="mainbar" style="width: 319px; ">
        <div class="article">
         ...
         <div>
         <div align="left">
          <img src="images/Cloud Computing Users.jpg" width="236" height="245" alt="" class="fl" />
          </div>
    ...
    <div align="center">
          <% Retriving_database rdb=Retriving_database.from_database();
          List user_detail=rdb.userdetail_retrieve();%>
          <table align="right" border="5"  cellpadding="5">
          <tr>
  
    
    <th width="66" bgcolor="#FFFFCC"  scope="col"><font color="#0000FF"><b>Name</b></font></th>
    <th width="87" bgcolor="#FFFFCC"  scope="col"><font color="#0000FF"><b>Username</b></font></th>
    <th width="76" bgcolor="#FFFFCC" scope="col"><font color="#0000FF""><b>Phone Number</b></font></th>
    <th width="67" bgcolor="#FFFFCC" scope="col"><font color="#0000FF"><b>Email id</b></font></th>
    <th width="125" bgcolor="#FFFFCC" scope="col"><font color="#0000FF"><b>Account Number</b></font></th>
  </tr>
