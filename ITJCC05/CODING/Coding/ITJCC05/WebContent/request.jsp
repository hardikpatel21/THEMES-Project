    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="request.jsp"><span>Requests</span></a></li>
  ...
  try
	{
		...
		System.out.println("select software and date from request_from_user where user='"+name+"'");
		ResultSet rs=st.executeQuery("select software,date from request_from_user where user='"+name+"'");
		while(rs.next())
		{
	...
	System.out.println("list is        nnnnnnnnnnnnnnnnnnnnn"+l);
  %>
...
<tr>
<td>
<input name="response" type="submit" value="Delete" />
</td>
</tr>
</table>
    </div>
