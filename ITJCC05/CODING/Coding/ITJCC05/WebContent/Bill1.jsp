...
<div class="main">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li   ><a href="response.jsp"><span>Response </span></a></li>
           <li class="active"><a href="Bill.jsp"><span>BILL</span></a></li>
  ...
  <!-- <form action="http://localhost:8084/ITJCC05-Themis/Homepage" enctype="multipart/form-data" method="post"> -->
    <div align="center" style="background-color:#FF9;text-align:center" >
    <!-- <p>&nbsp;</p>
    ...
    <p>&nbsp;</p> -->
    <p>YOUR REQUEST FOR BILLING IS SUCCESSFULLY SEND TO CNA............ :-)</p>
    </div>
