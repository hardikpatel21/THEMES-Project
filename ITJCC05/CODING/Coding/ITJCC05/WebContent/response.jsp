...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li  class="active" ><a href="response.jsp"><span>Response </span></a></li>
  ...
  <tr>
    ...
    <th width="70" scope="col"><font color="#990066"> User</font></th>
 ...
 <%=l.get(i) %>
  ...
  <%i++; %>
   ...
   <img src="images/320_pdf_icon_16.gif" width="18" height="18" alt="" class="fl" />
  <a href="SLA\\<%=l.get(i) %>"><%=l.get(i) %></a>
  <%i++; %>
  </td>
   <td><%=l.get(i) %></td>
   <td>
   <%String[] swname=sw.split("\\."); 
  	
  	System.out.println("HAI HAI HAI"+swname[0]);%>
   <a href="http://localhost:8084/ITJCC05-Themis/BILL/<%=swname[0]%> bill.pdf">view</a>
   </td>
   </tr>
...
<table align="center">
<tr>
  <td><input name="SLA" type="submit" value="Delete" /></td>
