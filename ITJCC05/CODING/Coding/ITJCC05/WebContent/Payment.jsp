...
<div class="main">
      ...
      <div class="menu_nav">
        <ul>
         <li ><a href="User_homepage.jsp"><span>Home</span></a></li>
          ...
          <li  class="active"><a href="ready_for_payment.jsp"><span>Payment</span></a></li>
  ...
  <div class="content">
    ...
    <div class="mainbar" style="width: 319px; ">
        <div class="article">
          <h2><span>LOGIN AS</span> <font color="blue"> </h2> 
  ...
  <p>&nbsp;</p>
   ...
   <form action="pay" method="post">
      <table width="323" border="0" cellspacing="5" cellpadding="5">
        <tr>
    <th width="156" scope="row"><font color="#330066">ACCOUNT NUMBER</font>
      </th>
    <td ><input type="text" name="account"></input>
  		</td>
  </tr>
  <tr>
    <th scope="row"><font color="#330066">PASSWORD</font> </th>
  ...
  <tr>
    <th scope="row"><font color="#330066">AMOUNT</font></th>
    <td><input type="text" name="amount" readonly="readonly" value="<%=request.getAttribute("amount") %>"></input></td>
  
  </tr>
  <tr><input type="submit" value="pay"></tr>
</table>    
</form>  
    </div>
