...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="user_profile.jsp"><span>Profile</span></a></li>
         
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="images/Man-and-Cloud1-960x360.jpg" width="960" height="360" alt="" />
  ...
  <div class="content">
    ...
    <div class="mainbar" style="width: 319px; ">
        <div class="article">
          <h2><span>LOGIN AS</span> <font color="blue"><%String name=session.getAttribute("username").toString(); %><%=session.getAttribute("username") %>
          </h2> 
         <a href="Home.jsp"> <h4><font color="red">logout</font></h4></a>         
         <div>
         <div align="left">
          <img src="images/12_User_Login.png" width="236" height="245" alt="" class="fl" />
          </div>
  ...
  <p>&nbsp;</p>
    ...
    <div align="center">
    <% user_profile udb=user_profile.from_database(); System.out.println("NAME"+name);
    List user_detail=udb.userdetail_retrieve(name);
    System.out.println(user_detail+"hhhhhhh");%>
      <table width="323" border="0" cellspacing="5" cellpadding="5">
        <tr>
    <th width="156" scope="row"><font color="#330066">Phone Number</font>
      </th>
    <td ><%=user_detail.get(0).toString() %>
  		</td>
  </tr>
  <tr>
    <th scope="row"><font color="#330066">Mail</font> </th>
    <td><%=user_detail.get(1).toString() %></td>
  </tr>
  <tr>
    <th scope="row"> <font color="#330066">Bank Account Number</font></th>
    <td><%=user_detail.get(2).toString() %></td>
  </tr>
  <tr>
    <th scope="row"><font color="#330066">Address</font></th>
    <td><%=user_detail.get(3).toString() %></td>
  </tr>
</table>      
    </div>
