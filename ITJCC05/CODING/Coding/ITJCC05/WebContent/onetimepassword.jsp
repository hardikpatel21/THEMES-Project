  ...
  <div class="content">
    ...
    <div class="mainbar" style="width: 319px; ">
        <div class="article">
         ...
         <div>
         <div align="left">
          <img src="images/1password_logo.png" width="260" height="245" alt="" class="fl" />
          </div>
    ...
    <div align="left">
      <p><h2><font color="#663333">ONE TIME PASSWORD</font></h2></p>
    </p>
    <form id="form1" name="form1" method="post" action="onetimepassword">
    <table width="460" border="0">
  <tr><font color="#000000">
    
    <th width="183" scope="col">Enter Your Account Id </th>
    <th width="156" scope="col" widthb="148"><input type="password" id="pass" name="pass" /></th>
    <th width="107" scope="col" widthb="148">
