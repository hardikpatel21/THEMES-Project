...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="CSP_Homepage.jsp"><span>Home Page</span></a></li>
  ...
  <div class="content">
    <div class="mainbar" style="width: 319px; ">
      ...
      <div><table width="1226" border="0">
  <tr>
    
    <th width="200"  scope="col"><font color="#993399"><b>Select</b></font></th>
    <th width="200"  scope="col"><font color="#993399"><b>Software Image</b></font></th>
    <th width="200" scope="col"><font color="#993399"><b>Software</b></font></th>
    <th width="200" scope="col"><font color="#993399"><b>Software Name</b></font></th>
    <th width="200" scope="col"><font color="#993399"><b>Service period</b></font></th>
    <th width="200" scope="col"><font color="#993399"><b>Cost in INR</b></font></th>
  </tr>
 <%for(int i=0;i<l.size();i++){ %>
  <tr>
    <td align="center">
      <input type="checkbox" name="select" id="select" value=<%=l.get(i) %> />
